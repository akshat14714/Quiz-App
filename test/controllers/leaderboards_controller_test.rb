...
class LeaderboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leaderboard" do
    assert_difference('Leaderboard.count') do
      post leaderboards_url, params: { leaderboard: { score: @leaderboard.score, sub_genre_id: @leaderboard.sub_genre_id, user_id: @leaderboard.user_id } }
    end
  ...
  test "should update leaderboard" do
    patch leaderboard_url(@leaderboard), params: { leaderboard: { score: @leaderboard.score, sub_genre_id: @leaderboard.sub_genre_id, user_id: @leaderboard.user_id } }
